...
<html lang="en">
<head>
    <title>Code coverage report for lib/endpoints/journeypath.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/endpoints/</a> journeypath.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y'>
        <span class="strong">3 statements</span>
...
&nbsp;
            request(reqString, function (error, response, body) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!error &amp;&amp; response.statusCode == 200) {
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (config.returnXML) {
                        /* istanbul ignore next */
<span class="cstat-skip" title="statement not covered" >                        return cb(body, null);</span>
                    } else {
                        xmlParser.parseString(body, function (err, result) {
                            <span class="missing-if-branch" title="else path not taken" >E</span>if (!err &amp;&amp; result) {
                                return cb(result['soap:Envelope']['soap:Body'][0]['GetJourneyPathResponse'][0]['GetJourneyPathResult'], null);
                            } else {
                                /* istanbul ignore next */
<span class="cstat-skip" title="statement not covered" >                                return cb(null, error);</span>
                            }
                        });
                    }
                } else {
